...
mesfig = lista_mes(iim).name(end-9:end-4)
...
text(1,290,['DAAT/PLEDS - Fortaleza/CE (Boia PNBOIA) -- ', mesfig])
...
for t=length(dire1):-1:2, %era ate 1
    s1=dire1(:,t);
    s2=espe1(:,t);
...
set(gcf,'paperOrientation','portrait','paperposition',[1 1 18 18],...
     'paperSize',[18 18]);
eval(['print(figure1,''-dpng'',''daatpleds_fortaleza_pnboia_', mesfig ''')']) 

...
a1=filter((out1 - 1i*out3)', 1, n1);
a2=filter((out1 - 1i*out3)', 1, n2);
a3=filter((out1 - 1i*out3)', 1, n3);
...
c01=cos(c0);
c02=sin(c0);           % Novos Parente
c03=angle(mean(c01)+j*mean(c02));  %
c03=ceil(c03*360/(2*pi));          %  

% calculo da direcao principal por maxima entropia
